...
- <details>
  <summary>👨‍💻 개인 역할</summary>
  <ul>
    <li><a href="#a-인증-기능">A. 인증 기능</a></li>
    <li><a href="#b-가계부-기능">B. 가계부 기능</a></li>
    <li><a href="#c-기타-기능-및-역할">C. 기타 기능 및 역할</a></li>
    <li><a href="#d-테스트">D. 테스트</a></li>
    <li><a href="#e-모니터링">E. 모니터링</a></li>
  </ul>
</details>
